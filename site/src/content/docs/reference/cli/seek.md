---
title: "spotuify seek"
description: "Seek relative to current playback position or to an absolute time"
---
...
Usage: spotuify seek [OPTIONS] <OFFSET>

Arguments:
  <OFFSET>  Seek target, e.g. +15s, -30s, 90s, or 2m
